...
data = [raw_values[split:-1], y_predicted_real, y_predicted_en, y_predicted_knn5, y_predicted_knn10]
misc.plot_lines_graph('Stationary, Test Data ', date[split:], titles, data)
