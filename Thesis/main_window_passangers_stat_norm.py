...
rmse, y_hat_predicted = compare(y_test, y_hat_predicted)
print('RMSE NoPredic  %.3f' % (rmse))
...
data = [[],y_hat_predicted, y_predicted_en, y_predicted_knn5, y_predicted_knn10,y_predicted_sgd]
...
data = [y_test, y_predicted_en_es, y_future_en_es, y_predicted_knn5_es, y_predicted_knn10_es, y_predicted_sgd_es]
misc.plot_lines_graph('Stationary - Normalization, Test Data ', date_test, titles, data)
...
misc.plot_lines_graph('Stationary - Normalization, Test Data ', date, titles, data)
