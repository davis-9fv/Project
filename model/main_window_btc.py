...
execute_train = False
max_lag = 100
correlations = [0 for x in range(1, max_lag)]
lags = [x for x in range(1, max_lag)]
...
for i in range(1, max_lag):
    ...
    if execute_train:
        ...
        rmse = compare(y_train, y_hat_predicted)
...
misc.plot_one_line('ElasticNet Finding best Window Size', lags, correlations, 'Window Size', 'RMSE')
